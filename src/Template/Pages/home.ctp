...
if (!Configure::read('debug')):
    throw new NotFoundException('XPlease replace src/Template/Pages/home.ctp with your own version.');
endif;
    ...
    <div id="content">
        <div class="row">
            <div class="columns large-12 ctp-warning checks">
                XPlease be aware that this page will not be shown if you turn off debug mode unless you replace src/Template/Pages/home.ctp with your own version.
            </div>
